  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        elevated: cn(
          "bg-linear-to-br from-[color-mix(in_oklab,var(--surface) 95%,transparent)] to-[color-mix(in_oklab,var(--bg) 80%,transparent)]",
          "border-[color-mix(in_oklab,var(--border) 70%,transparent)]",
          "shadow-[0_12px_36px_rgba(0,0,0,0.24)] hover:shadow-[0_18px_46px_rgba(0,0,0,0.30)]"
        ),
        gradient: cn(
          "bg-linear-to-br from-[color-mix(in_oklab,var(--primary) 10%,transparent)] via-[color-mix(in_oklab,var(--surface) 80%,transparent)] to-[color-mix(in_oklab,var(--accent) 10%,transparent)]",
          "border-[color-mix(in_oklab,var(--border) 70%,transparent)]",
